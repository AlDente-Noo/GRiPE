...
public class TFcooperativity implements Serializable {
    ...
    public TFcooperativity(int species0ID, int species1ID, int type, int direction0, int direction1,
                           DNAregion region0, DNAregion region1, double dimerisationProbability,
    ...
    public TFcooperativity(TFcooperativity coop) {
        ...
        this.isReversible = coop.isReversible;
