...
public class Gillespie {
    ...
    public static int getNextReaction(double value, double[] ribosomeBindingPropensity) {
        ...
        throw new RuntimeException("Error while computing next reaction sum:" + value + "\nPropensities: ");
    }
    ...
    public static int getNextReaction(double propensitySum, HashMap<Integer, Double> propensity, double reactionRate) {
        double sum = 0;
        Integer key;
        for (Integer integer : propensity.keySet()) {
            key = integer;
        ...
        throw new RuntimeException("Error while computing next reaction:");
    }
